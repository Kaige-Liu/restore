        ...
        for epoch in range(args.epochs):
            ...
            for snr in tqdm(SNR):  # 对每个信噪比 所有的数据
                ...
                for sents in test_iterator:
                    ...
                    out = greedy_decode(args, deepsc, alice_bob_mac, key_ab, eve, Alice_KB, Bob_KB, Eve_KB, Alice_mapping, Bob_mapping, Eve_mapping,
                                                                                        sents,
...
if __name__ == '__main__':
    ...
    bleu_score, zheng_mac_score, eve_mac_0_score, tamper_0_score = performance(args, SNR, deepsc, alice_bob_mac, key_ab, eve, Alice_KB, Bob_KB, Eve_KB, Alice_mapping, Bob_mapping, Eve_mapping)
    print("bleu_score:")
