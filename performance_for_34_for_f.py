...
from utlis.trainer_for_34_for_f import train_step, val_step, greedy_decode, initNetParams, DDIMScheduler
...
if __name__ == '__main__':
    ...
    checkpoint_34_all = torch.load(
        r'/root/autodl-tmp/restore/checkpoints/f/checkpoint_318_0.9089.pth')
    ...
    model_state_dict = checkpoint_34_all['deepsc']
    ...
    cdmodel_state_dict = checkpoint_34_all['cdmodel']
